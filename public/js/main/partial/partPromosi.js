    ...
    if (currentPromoItem.produk.length > 1) {
                ...
                <div class="promo-product-option">
                    <label class="promo-product-label">
                        ...
                        <div class="promo-product-info">
                            ...
                            <span class="promo-product-price">${produk.harga_formatted}</span>
                        </div>
                    </label>
                </div>
            `;
        ...
        modalBody.innerHTML = `
            <div class="promo-single-product-info">
                ...
                <div class="promo-single-product-price">${produk.harga_formatted}</div>
...
function confirmPromoPurchase() {
    ...
    const url = window.confirmPromoRoute + `?produk=${encodeURIComponent(JSON.stringify([selectedProduct]))}&harga=${selectedProduct.harga}`;
