...
@section('konten')
    <link rel="stylesheet" href="{{ asset('css/main/event/resep.css') }}" />

    <div class="container my-5">
        <div class="row d-flex align-items-start">
            <!-- Konten utama -->
            <div class="col-lg-8 mb-4 mb-lg-0">
                <h1 class="text-center mb-5"><strong>MY RECIPE</strong></h1>
                <hr>
                ...
                <div class="mb-5 pe-lg-4">
                    ...
                    <ol>
                        ...
                        <li>Matikan kompor, masukkan terigu & vanilla, aduk cepat. Nyalakan kembali dengan api kecil hingga
                            kalis.</li>
                        <li>Masukkan telur, aduk rata. Masukkan ke plastik segitiga yang sudah diberi spuit.</li>
                        <li>Siapkan loyang beralas tepung, semprotkan adonan memanjang. Simpan di freezer hingga agak keras.
                        </li>
                    ...
                    <p>Menu pendamping apa yang cocok sama es krim selain roti? <strong>Churros</strong> bisa nih! Selain
                        enak, bikinnya juga simple 😋</p>
                ...
                <div class="mb-5 pe-lg-4">
                    ...
                    <p class="fs-5 fw-bold">Cara Membuat:</p>
                    <ol>
                        <li>Panaskan minyak pada wajan, tambahkan bombay dan bawang putih, lalu tumis hingga setengah
                            matang. Masukkan pasta tomat dan bubuk cabai.</li>
                        <li>Masukkan daging giling dan garam lalu masak hingga matang.</li>
                        <li>Masukkan daging pada lembaran taco. Hias dengan tomat, daun lettuce, dan keju cheddar yang sudah
                            diparut.</li>
                    </ol>
                    ...
                    <p>Bikin masakan yang bisa dimasak bareng anak yuk, biar bisa seru-seruan juga nih di dapur sambil
                        merasakan proses membuat makanan, jadi lebih seru dan pastinya jadi pengalaman menarik buat anak😉🥰
                    </p>
    ...
    <script src="{{ asset('js/main/event/resep.js') }}"></script>
@endsection