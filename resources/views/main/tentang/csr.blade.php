...
@section('konten')
        ...
        <div class="row p-4 g-4">
            @for ($i = 1; $i <= 4; $i++)
                <div class="col-md wow fadeInUp">
                    <img class="img-fluid" src="{{ asset('img/tentangkami/csr/' . $i . '.jpg') }}"
                        alt="CSR {{ $i }}" style="border-radius: 15px; cursor: pointer;"
    ...
    <script src="{{ asset('js/main/tentang/csr.js') }}"></script>
@endsection
