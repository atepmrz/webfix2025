...
@section('konten')
    ...
    <link rel="stylesheet" href="{{ asset('css/main/tentang/karir.css') }}" />
    ...
    <section id="karir" class="container-fluid">
        ...
        <!-- Page 1 Content -->
        <div id="content-page-1" class="page-content page-1">
            <!-- Baris 1 -->
            <div class="row p-4 g-4">
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/26.jpeg') }}" alt="Loker"
                    ...
                    <br>
                    <a href="https://bit.ly/RekrutmenPramaBorma-Ags25" target="_blank" class="text-center lead"
                        data-wow-delay="0.1s">
                ...
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/25.jpeg') }}" alt="Loker"
                            style="border-radius: 15px"
                            onclick="openImageModal.show({
                    img: this,
                    animate: true
                    ...
                    <br>
                    <a href="https://bit.ly/RekrutmenPramaBorma-Ags25"
                ...
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/24.jpeg') }}" alt="Loker"
                            style="border-radius: 15px"
                            onclick="openImageModal.show({
                    img: this,
                    animate: true
            ...
            <div class="row p-4 g-4">
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/23.jpeg') }}" alt="Loker"
                            style="border-radius: 15px"
                            onclick="openImageModal.show({
                    img: this,
                    animate: true
                ...
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/22.jpeg') }}" alt="Loker"
                            style="border-radius: 15px"
                            onclick="openImageModal.show({
                    img: this,
                    animate: true
                ...
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img class="img-fluid" src="{{ asset('img/tentangkami/karir/21.jpeg') }}" alt="Loker"
                            style="border-radius: 15px"
                            onclick="openImageModal.show({
                    img: this,
                    animate: true
                    ...
                    <br>
                    <a href="https://bit.ly/RekrutmenPramaBorma-Juli25"
                        target="_blank" class="text-center lead" data-wow-delay="0.2s">
                        <i class="bi bi-journal-text"></i> Kirim CV Lamaran disini
                    </a>
                </div>
        ...
        <!-- Page 2 Content -->
        <div id="content-page-2" class="page-content page-2">
            <!-- Baris 1 -->
            <div class="row p-4 g-4">
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
        ...
        <!-- Page 3 Content -->
        <div id="content-page-3" class="page-content page-3" style="display: none;">
            <!-- Baris 1 -->
            <div class="row p-4 g-4">
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
        ...
        <!-- Page 4 Content -->
        <div id="content-page-4" class="page-content page-4" style="display: none;">
            <!-- Baris 1 -->
            <div class="row p-4 g-4">
                <div class="col-md">
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
        ...
        <script src="{{ asset('dist/open-image-modal.js') }}"></script>
            <script src="{{ asset('js/main/tentang/karir.js') }}"></script>
